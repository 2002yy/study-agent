...
def test_runtime_version_is_synced():
    ...
    assert 'current_version: str = "v0.7.8"' in mode_text
    assert 'next_version: str = "v0.7.9"' in mode_text
    assert '- current_version: v0.7.8' in state_text
    assert '- next_version: v0.7.9' in state_text
    assert "current: v0.7.8" in yaml_text
    assert "next: v0.7.9" in yaml_text
