...
- v0.7.3 服务层拆分与工程化收口已全部完成（wechat_service 拆分 + session flush 批量 + GitHub Actions CI + 架构测试 + LLM client 扩展 + YAML runtime state 真源化）
- 下一阶段 v0.7.4 回归功能增量，重点：联网搜索质量提升、来源 UI 优化、搜索交互体验
