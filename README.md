...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-312%20passed-green" alt="312 tests passed">
</p>
...
- **312 pytest tests**, Ruff clean, mypy clean, GitHub Actions CI workflow
...
```bash
pytest tests/ -v            # current local baseline: 312 passed
...
- [x] FastAPI service layer foundation: `/health`, `/chat`, `/memory/preview`, `/memory/commit`, `/sessions`, `/rag`, `/rag/index`, `/rag/query`, `/rag/status`, `/rag/upload`, `/rag/local-knowledge`, `/tools` and `/workflows/runs` implemented; streaming, auth and frontend-specific contracts remain planned
...
- [ ] P9 web UI: React + Vite + TypeScript, streaming chat, workflow timeline, source panel and memory/tool confirmation UI
