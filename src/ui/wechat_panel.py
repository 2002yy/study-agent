...
def _run_news_search(query_text: str, read_articles: bool = True) -> None:
    ...
    if submitted:
        ...
        if not query:
            ...
            with st.spinner("正在搜索..."):
                try:
                    _run_news_search(query, read_articles=read_articles)
                except Exception as exc:
