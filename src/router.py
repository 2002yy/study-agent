...
FALLBACK_RULES = [
    (["别直接告诉我", "引导我思考", "一步步问我", "让我自己推出", "用苏格拉底法", "带我发现", "先听我的判断", "不要马上给答案", "通过反例引导我", "我想自己想明白"], "nahida", "苏格拉底", "pro", "明确要求苏格拉底式再发现", 105),
    (["为什么", "本质", "底层", "机制", "原理", "从根上讲"], "nahida", "普通", "pro", "深入机制解释", 80),
    ...
    (["入门", "开始学", "新手", "零基础"], "march7", "普通", "flash", "入门解释", 50),
]
