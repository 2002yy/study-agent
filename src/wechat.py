...
All implementations have been split into sub-modules:
  - src/wechat_format.py         — pure text/formatting utilities
  - src/wechat_state.py          — file I/O, group state, lifecycle
  - src/wechat_generator.py      — LLM-based generation logic
  - src/wechat_prompt.py         — system/interactive prompt loaders
